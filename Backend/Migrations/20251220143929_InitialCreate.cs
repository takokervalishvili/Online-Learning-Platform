        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultations_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Avatar", "CreatedAt", "Email", "FirstName", "LastName", "PasswordHash", "PasswordResetExpiry", "PasswordResetToken", "Role" },
                values: new object[] { 1, null, new DateTime(2025, 12, 20, 14, 39, 29, 762, DateTimeKind.Utc).AddTicks(2406), "admin@learningplatform.com", "System", "Administrator", "$2a$11$.yum/6vzJrdyKP2IxnJDpea7uaoHAEyZgnJwj4Je8VwB362cl3pTC", null, null, "ADMIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_CourseId",
                table: "Consultations",
                column: "CourseId");
